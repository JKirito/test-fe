...
import styles from './MethodologyManagement.module.scss'; // Updated import for CSS Modules
...
const MethodologyManagement: React.FC = () => {
  ...
  return (
    <div className={styles.methodologyManagement}>
      <div className={styles.methodologyManagement__header}>
        <h2 className={styles.methodologyManagement__title}>Methodologies Management</h2>
        <Button
          variant="primary"
      ...
      <div className={styles.methodologyManagement__content}>
        <MethodologyTree
...
export default MethodologyManagement; // Renamed export
